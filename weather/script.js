  ...
  async function weatherData(city) {
    ...
    for (let i = 1; i < 8; i++) {
      ...
      if (
        ...
        document.querySelector(`.i${i}`).src = "moderate.jfif";
      } else if (description == "Partly cloudy") {
        document.querySelector(`.i${i}`).src = "partly cloudy.jfif";
      } else if (description == "Sunny") {
        document.querySelector(`.i${i}`).src = "sunny.jfif";
      } else if (description == "Heavy rain") {
        document.querySelector(`.i${i}`).src = "heavy.jfif";
      } else if (description == "Overcast") {
        document.querySelector(`.i${i}`).src = "overcast.jfif";
      }
    }
  }
